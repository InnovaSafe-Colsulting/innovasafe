...
.pm-section-label {
    ...
    grid-column:1/-1; margin-top:.5rem; padding-top:.75rem; border-top:1px solid #1e293b;
}
...
@media (min-width:769px) { .pm-mobile-list { display:none; } }
</style>
...
<div class="pm-overlay" wire:click.self="closeModal">
    <div class="pm-modal">
        ...
        <div class="pm-modal-body">
            @php $showAll = !$editingId || $name === 'PayU'; @endphp
            <div class="pm-form-grid">
                ...
                @if($showAll || $bank || $account_type || $account_number || $holder || $nit || $cellphone || $value || $agreement || $reference)
                ...
                <div class="pm-form-group">
                    ...
                    @if(isset($formErrors['holder']))<div class="err">{{ $formErrors['holder'] }}</div>@endif
                </div>
                @endif
                @if($showAll || $nit)
                <div class="pm-form-group">
    ...
    <div class="pm-modal" style="max-width:380px;">
        ...
        <div class="pm-modal-body">
            <p style="color:#cbd5e1;font-size:.85rem;margin:0;">
                ¿Estás seguro de que deseas eliminar este tipo de pago? También se eliminarán sus detalles y no se puede deshacer.
            </p>
        </div>
        <div class="pm-modal-footer">
            <button class="btn-cancel" wire:click="closeModal">Cancelar</button>
