        ...
        <div class="grid lg:grid-cols-2 gap-12">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-8">
                ...
                <form id="form-contact" class="space-y-4">
                    ...
                    <button type="submit" class="btn w-full bg-[#39bf24] hover:bg-[#2ea31d] text-white font-semibold py-4 rounded-full transition flex items-center justify-center gap-2">
